...
document.body.appendChild(canvas /*Area*/);
...
document.body.appendChild(hintAndPlayAgain);
...
function comentary()
{
    ...
    {
        alert('Awesome..!! You are a STREAK..!.');
    }
}
...
var wordList = [ 
    ...
    ['algorithm','argument','array','assignment','bug','compiler','function','object oriented','syntax'] 
];
...
function hint(){
    var hint = [['the smallest component of an element','an elementary particle with negative charge',
	      ...
	      ['a step-by-step procedure to achieve a specific goal','a value that is passed into a function when it is called',' a type of value that contains a sequence of other values','the act of putting a value into a variable',' a mistake in a program',
          ' a program that converts code into an executable, and checks that the syntax is correct','a piece of code that is not run until it is called','designed using objects','the grammatical rules of a programming language']];
...
drawList = [leftLeg,rightLeg,leftHand,rightHand,hisBody,head,hanger,roof,pole,base];
...
document.getElementById('hangHere').appendChild(base);